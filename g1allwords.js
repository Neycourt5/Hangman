...
const gradeChoice = document.querySelector('.grades');
...
//to do later when i get the vocab lists
// gradeChoice.addEventListener("click", (e) => {
...
//to do later when i get the other vocab lists in
// const changeVocablist = (gradeNum) => {
//     while (allWords.length > 0) {
//         allWords.pop();
//     }
// }